...
import { Room } from '../../../db_services/v1/room/room.class';
import { roomPath } from '../../../service_endpoints/services';
...
export class RoomManagement implements ServiceMethods<Data> {
  app: Application;
  options: ServiceOptions;
  service: Room & ServiceAddons<any>;

  constructor(options: ServiceOptions = {}, app: Application) {
    this.options = options;
    this.app = app;
    this.service = app.service(roomPath);
  }
