...
import {
    Category_QUERY as Query,
    Category_POST as Body_POST,
    Category_FIND as Data,
    Category_GET as Datum,
    Category_PATCH as Body_Patch,
} from '../interfaces/CategoryInterface';
import { Category } from "../category.class";

export class CategoryDBOperations {
    private static _service: Category & ServiceAddons<any>;
    static _model: Model<Document<any>>;
    static _servicePath = 'v1/category';

    /**
     * Initialize service
     * @param service - Service value.
     */
    static initializeService(service: Category & ServiceAddons<any>) {
        CategoryDBOperations._service = service;
        CategoryDBOperations._model = service.Model;
    }
    ...
    static async getDataWithPagination({
        ...
        return await CategoryDBOperations._service
            ._find({
                query: {
                    ...dbQuery,
                    ...specifiedQuery,
