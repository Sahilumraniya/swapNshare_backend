...
import {
    Room_QUERY as Query,
    Room_POST as Body_POST,
    Room_FIND as Data,
    Room_GET as Datum,
    Room_PATCH as Body_Patch,
} from '../interfaces/RoomInterface';
import { Room } from "../room.class";

export class RoomDBOperations {
    private static _service: Room & ServiceAddons<any>;
    static _model: Model<Document<any>>;
    static _servicePath = 'v1/room';

    /**
     * Initialize service
     * @param service - Service value.
     */
    static initializeService(service: Room & ServiceAddons<any>) {
        RoomDBOperations._service = service;
        RoomDBOperations._model = service.Model;
    }
    ...
    static async getDataWithPagination({
        ...
        return await RoomDBOperations._service
            ._find({
                query: {
                    ...dbQuery,
                    ...specifiedQuery,
